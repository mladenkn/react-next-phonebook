...
export const HeartBorderIcon = ({ className }: Props) => (
  <svg className={cn(defaultStyle, className)} viewBox="0 0 24 24">
...
export const RemoveIcon = ({ className, style }: Props & { style?: CSSProperties }) => (
  <svg className={cn(defaultStyle, className)} style={style} viewBox="0 0 24 24">
    <path d="M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path>
  </svg>
)

export const RemoveCircledIcon = ({ className }: Props) => (
  <svg className={cn(defaultStyle, className)} viewBox="0 0 24 24">
