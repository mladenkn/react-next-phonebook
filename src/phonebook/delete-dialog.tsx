...
const DeleteModal = ({ text, isOpen, onCancel, onConfirm }: Props) => (
  // <div className="fixed inset-0 flex items-center justify-center overflow-y-auto bg-white">
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto">
    <div className="rounded bg-white p-8 shadow-lg">
      <p className="text-lg">
        Hello, I'm a basic modal! sdf asdčlfk jasdčfklj asdč fjasčdfj čdklsjf ačkdfj as df
        asdfčahjsdf kasdf ajsdf a sdf asdćfkjasdč fj
      </p>
      <p className="text-lg">
        Hello, I'm a basic modal! sdf asdčlfk jasdčfklj asdč fjasčdfj čdklsjf ačkdfj as df
        asdfčahjsdf kasdf ajsdf a sdf asdćfkjasdč fj
